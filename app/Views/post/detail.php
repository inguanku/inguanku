        ...
        <div class="col">
            <div class="card mx-auto" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <?= ($dataDetail[0]['user_id'] == $user_id) ? "<a href='#' class='mt-1 mx-auto d-block btn btn-danger'>Delete Post</a>" : "<a href='#' class='mt-1 mx-auto d-block btn btn-warning'>Request Me!</a>"; ?>
                </div>
            </div>
        </div>
    </div>
